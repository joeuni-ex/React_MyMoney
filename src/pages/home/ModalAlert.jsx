const ModalAlert = ({ onModalAlert, item }) => {
  return (
    <div className="h-full w-screen fixed left-0 top-0 flex  justify-center items-center bg-black bg-opacity-10 text-center">
      <div className=" rounded w-6/12 md:w-1/3 h-max bg-yellow-100">
